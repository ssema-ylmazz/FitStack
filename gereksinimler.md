...
4. Kullanıcı profil bilgilerini günceller. (PUT)
5. Kullanıcı hesabını siler. (DELETE)
6. Kullanıcı hazır egzersiz programlarını listeler. (GET)
7. Kullanıcı programları zorluk seviyesine göre filtreler. (GET)
...
1. [Sema Nur Yılmaz'ın Gereksinimleri](Sema-Yilmaz-Gereksinimler.md)
